...
with tab1:
    ...
    st.write("**Name:** [Your Name Here]")  # TODO: Update with your name
...
with tab2:
    ...
    with col2:
        ...
        if conn:
            cursor = conn.cursor()
            cursor.execute("SELECT MIN(votes), MAX(votes) FROM restaurants WHERE votes IS NOT NULL")
...
with tab3:
    st.title("🗺️ Restaurant Locations Map")
